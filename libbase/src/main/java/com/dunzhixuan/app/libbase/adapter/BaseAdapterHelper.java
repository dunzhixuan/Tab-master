...
public class BaseAdapterHelper {
     ...
     * 设置TextView的左右的图片
     *
     * @param viewId  textView 控件
     * @param resId   图片资源ID
     * @param isRight 图片是否在文字的右边
     * @return
     */
    public BaseAdapterHelper setTextViewLRDrawable(int viewId, int resId, boolean isRight) {
        TextView view = retrieveView(viewId);
        if (resId == -1) {
    ...
    public BaseAdapterHelper setTextViewLDDrawable(int viewId, int leftResId, int downResId, int drawablePading) {
        TextView view = retrieveView(viewId);

        Drawable leftImg = context.getResources().getDrawable(leftResId);
        Drawable downImg = context.getResources().getDrawable(downResId);
        ...
        view.setCompoundDrawables(leftImg, null, null, downImg);
        view.setCompoundDrawablePadding(drawablePading);
        return this;
    }

    public BaseAdapterHelper setViewPading(int viewId, int left, int top, int right, int bottom) {
        View view = retrieveView(viewId);
    ...
    //设置margin 左上角
    public BaseAdapterHelper setViewMargin(int viewId, int margin) {
        View view = retrieveView(viewId);
        int layoutMargin = UIUtils.convertDip2Px(context, margin);
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        if (layoutParams instanceof RelativeLayout.LayoutParams) {
            RelativeLayout.LayoutParams rlParams = (RelativeLayout.LayoutParams) layoutParams;
            rlParams.topMargin = layoutMargin;
            rlParams.rightMargin = layoutMargin;
            view.setLayoutParams(rlParams);
        } else if (layoutParams instanceof LinearLayout.LayoutParams) {
            LinearLayout.LayoutParams llParams = (LinearLayout.LayoutParams) layoutParams;
            llParams.topMargin = layoutMargin;
            llParams.rightMargin = layoutMargin;
...
//	}
    ...
    public BaseAdapterHelper setViewClickable(int viewId, boolean isClickable) {
        View view = retrieveView(viewId);
